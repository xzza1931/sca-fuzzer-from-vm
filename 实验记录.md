...
python3 revizor.py mutate -s base.json -c tests/configs/v1-mutate-test.yaml -n 1 -i 100 -w wd-mutate -t s1-test/s1-test.asm
python3 revizor.py mutate -s base.json -c tests/configs/v1-mutate-test.yaml -n 1 -i 100 -w wd-mutate -t s1-test/generator-test.asm --enable_spec_mutate true
python3 revizor.py minimize -s base.json -c tests/configs/v1-mutate-test.yaml -g wd-v1/violation-250827-213422/program.asm -o wd-v1/violation-250827-213422/minimized.asm -i 100 --num-attempts 10 --enable-simplification-pass