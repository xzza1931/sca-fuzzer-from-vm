...
def main() -> int:
    ...
    parser_tfuzz.add_argument(
        ...
        type=arg2bool,
        default=False,
        help="If set, enable mutation of the specification.",
    )

    # ==============================================================================================
    # Fuzzing
    parser_fuzz = subparsers.add_parser('fuzz-v5', add_help=True, parents=[common_parser])
    parser_fuzz.add_argument(
        "-n",
        "--num-test-cases",
        type=int,
    ...
    # fuzz-v5
    if args.subparser_name == 'fuzz-v5':
